...
document.addEventListener("DOMContentLoaded", function () {
  addPopupListeners("PopUpYoutube", "YoutubeClose", "YoutubeOK");
  addPopupListeners("PopUpTelegram", "TelegramClose", "TelegramOK");
  addPopupListeners("PopUpDiscord", "DiscordClose", "DiscordOK");
  addPopupListeners("PopUpGithub", "GithubClose", "GithubOK");
});
...
if (window.matchMedia("(max-width: 767px)").matches) {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    button.addEventListener('click', function() {
      counter++;
      if (counter % 2 === 1) {
        desktop.style.backgroundImage = 'url(./images/lain.png)';
      } else {
